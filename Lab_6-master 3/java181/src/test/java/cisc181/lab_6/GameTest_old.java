...
public class GameTest_old {
    ...
    public void testMaxConsec() {
        ...
        assertEquals(board.getNumConsec(4,0,0,1,'O'),3);
    ...
    public void testTicTacToeTypeGame()throws Exception {
        ...
        testGame.setPieceOnBoard(1,1,green);
        testGame.changeTurn();

        System.out.println();
        testGame.getGameBoard().printBoard();
        System.out.println(testGame.getStatus());
        testGame.setPieceOnBoard(1,0,blue);
        testGame.changeTurn();
        ...
        testGame.getGameBoard().printBoard();
        System.out.println(testGame.getStatus());
        testGame.setPieceOnBoard(2,2,green);
        testGame.changeTurn();

        System.out.println();
        testGame.getGameBoard().printBoard();
        System.out.println(testGame.getStatus());
        testGame.setPieceOnBoard(2,0,blue);
        testGame.changeTurn();

        System.out.println();
        testGame.getGameBoard().printBoard();
        System.out.println(testGame.getStatus());
        testGame.setPieceOnBoard(3,3,green);
        testGame.changeTurn();
